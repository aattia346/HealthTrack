	...
	public ModelAndView adminLoginSubmit(@CookieValue(value="lang", defaultValue="en") String cookie, ModelMap m, HttpServletRequest request)
		...
		String name	 = request.getParameter("name");
	   	...
	   	if(!Validation.validateName(name)) {
	   		m.addAttribute("invalidName", "<p class=\"wrong-input\">" + t.write("Invalid Name") + "</p>");
	   		errors = true;
	   	}
	   	
	   	if(!Validation.validateEmail(email)) {
	   		m.addAttribute("invalidEmail", "<p class=\"wrong-input\">" + t.write("Invalid Email") + "</p>");
	   		errors = true;
	   	}
	   	
	   	if(!Validation.validateText(msg)) {
	   		m.addAttribute("invalidMsg", "<p class=\"wrong-input\">" + t.write("your messagr has invalid characters") + "</p>");
	   		errors = true;
	   	}
	   	...
	   	if(!errors) {
	   		...
	   		m.addAttribute("contactSucceed", "<p class=\"reviewSucceeded\">" + t.write("Thanks for your contact") + "</p>");
	   	}
