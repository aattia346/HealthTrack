...
public class ServiceController {
	...
	@RequestMapping(value = "/healthTrack/Service/Verify/Booking/{place}/{serviceId}/{bookingId}", method = RequestMethod.GET)
	public ModelAndView verifyBookingByPlaceAdmin(@PathVariable("place") String place,
			@CookieValue(value = "lang", defaultValue = "en") String cookie, @PathVariable("bookingId") int bookingId,
			@PathVariable("serviceId") int serviceId, ModelAndView mav, ModelMap model, HttpServletRequest request) throws Exception {
	...
	public ModelAndView unverifyBooking(@PathVariable("place") String place,
		...
		@RequestMapping(value = "/healthTrack/Service/Unverify/Booking/{place}/{serviceId}/{bookingId}", method = RequestMethod.GET)
		public ModelAndView unverifyBookingByPlaceAdmin(@PathVariable("place") String place,
				@CookieValue(value = "lang", defaultValue = "en") String cookie, @PathVariable("bookingId") int bookingId,
				@PathVariable("serviceId") int serviceId, ModelAndView mav, ModelMap model, HttpServletRequest request)
				throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
	...
	@RequestMapping(value = "/healthTrack/Service/Delete/Booking/{place}/{serviceId}/{bookingId}", method = RequestMethod.GET)
	public ModelAndView deleteBookingByHospitalAdmin(@CookieValue(value = "lang", defaultValue = "en") String cookie, @PathVariable("bookingId") int bookingId,
			@PathVariable("place") String place, @PathVariable("serviceId") int serviceId, ModelAndView mav, ModelMap model, HttpServletRequest request) throws Exception {
