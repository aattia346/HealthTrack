                      ...
                      <div class="container">
					    ...
					    <div class="row">
					        <div class="form-group name1 col-md-6">
					            ...
					            <input type="text" placeholder="<%=t.write("Enter Pharmacy Name",lang) %>" class="form-control" name="name" required="required" value="${oldName}" maxlength="50">
					             ${invalidName}
					             ${nameExist}
					             ${shortName}
					        </div>
        	...
        	<input type="hidden" name="pharmacyId" value="<%= pharmacy.getPharmacyId() %>">
                    <div class="card">
                      ...
                      <div class="container">
                        ...
                        <div class="form-group"><label class=" form-control-label"><%=t.write("Google Maps URL",lang) %></label><input type="text" placeholder="<%=t.write("Enter the link of the location of google maps",lang) %>" class="form-control" name="url" required="required" value="<%= pharmacy.getGoogleMapsUrl() %>"></div>
