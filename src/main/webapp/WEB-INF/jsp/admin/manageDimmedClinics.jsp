...
<%if(action.equalsIgnoreCase("add")){
	String title = "Add New Dimmed Clinic";
...
<div class="breadcrumbs">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><%=t.write("Add New Dimmed Clinic",lang) %></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <form class="col-lg-12" action="/HealthTrack/admin/DimmedClinics/insert" method="post">
                    <div class="card">
                      <div class="card-header"><strong><%=t.write("Dimmed Clinic",lang) %></strong><small><%=t.write("Form",lang) %> </small></div>
