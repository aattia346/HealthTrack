...
<%if(action.equalsIgnoreCase("add")){
	String title = "Add New Dimmed Center";
...
<div class="breadcrumbs">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><%=t.write("Add New Dimmed Center",lang) %></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <form class="col-lg-12" action="/HealthTrack/admin/DimmedCenters/insert" method="post">
                <div class="card">
                      <div class="card-header"><strong><%=t.write("Dimmed Center",lang) %></strong><small> <%=t.write("Form",lang) %></small></div>
                <div class="container">
					    ...
					    <div class="row">
					        <div class="form-group name1 col-md-6">
					           ...
					           <input maxlength="50" type="text" placeholdk2er="<%=t.write("Address",lang) %>" class="form-control" name="address" required="required" value="${oldAddress}">
					        ${invalidAddress}
					        </div>
