                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      <c:forEach var="user" items="${users}">
                        ...
                        <%if(user.getBan()==1){ %>
                       <a href="/HealthTrack/user/unban/<%= admin.getId() %>/${user.id}" class="btn btn-success confirm-Ban-user">unBan</a>
                       
                        <%}else{ %>
                        <a href="/HealthTrack/user/ban/<%= admin.getId() %>/${user.id}" class="btn btn-warning confirm-unBan-user">Ban</a>
