...
<html>
    ...
    <title><%= t.write(clinic.getClinicName(),lang) + " " + t.write("Bookings",lang) %></title>
        ...
        <div class="breadcrumbs">
            <div class="col-sm-6">
             ...
             <div class="col-sm-6">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h4><%= t.write(clinic.getClinicName(),lang) + t.write("/",lang) + t.write("Bookings",lang) %></h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <c:forEach var="booking" items="${bookings}">
                        ...
                        <td>
	                        <div>
		                    	...
		                    	<% if(b.getStatus()==0){ %><a class="confirm-verify-booking dashboard-btn" href="/healthTrack/Clinic/VerifyBooking/<%= clinic.getClinicId() %>/${booking.bookingId}" title="<%=t.write("Confirm This Booking",lang) %>"><i class="fa fa-check-circle"></i></a><% }else{ %>
		                     	<a class="confirm-unverify-booking dashboard-btn" href="/healthTrack/Clinic/UnverifyBooking/<%= clinic.getClinicId() %>/${booking.bookingId}" title="<%=t.write("Unconfirm This Booking",lang) %>"><i class="fa fa-close"></i></a><% } %>
	                         	<a class="dashboard-btn confirm-delete-booking" href="/healthTrack/Clinic/DeleteBooking/<%= clinic.getClinicId() %>/${booking.bookingId}" title="<%=t.write("Delete This Booking",lang) %>"><i class="fa fa-trash"></i></a> 	
	                         </div>
                        </td>     
                        </tr>                 
                      </c:forEach>
