...
%>
    ...
    <section class="breadcumb-area bg-img gradient-background-overlay" style="background-image: url(/user/layout/images/profiles/bg-img/breadcumb2.jpg);">
     ...
     <a href="/HealthTrack/admin/<%=username%>/Clinic/${clinicId}/showComments" class="btn-lg btn btn-imperial"><i class="fa fa-plus"></i> <%= t.write("Manage Comments") %></a>
     <a href="/HealthTrack/admin/<%=username%>/Clinic/${clinicId}/showBookings"" class="btn-lg btn btn-imperial"><i class="fa fa-plus"></i> <%= t.write("Manage Bookings") %></a>
   					<% }%>
                </div>
