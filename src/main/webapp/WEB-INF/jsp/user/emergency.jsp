...
for(Pharmacy pharmacy : pharmacies){
	...
	Location location = new Location(pharmacy.getLat(), pharmacy.getLang(), "pharmacy", t.write(pharmacy.getPharmacyName()) + " " + t.write("at") + " " + t.write(pharmacy.getAddress()) , serviceUrl, pinColor);
...
for(Clinic clinic : clinics){
	...
	Location location = new Location(clinic.getLat(), clinic.getLang(), "clinic", t.write(clinic.getClinicName()), serviceUrl, pinColor);
	locations.add(location);
}
...
for(Hospital hospital : hospitals){
	...
	Location location = new Location(hospital.getLat(), hospital.getLang(), "hospital", t.write(hospital.getHospitalName()), serviceUrl, pinColor);
	locations.add(location);
}
	            ...
	            <section class="emergency-parts">
	                <div class="row">
	                    ...
	                    <div class="emergency-part col-sm-4">
	                        <a href="#" id="pharmacy">
	                            <div class="inner-emergency-part">
	                                <p class="text-center"><%= t.write("pharmacy") %></p>
	                            </div>
	                        </a>
	                    </div>
	                    <div class="emergency-part col-sm-4">
